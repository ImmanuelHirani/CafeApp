const toggleTabs = document.querySelectorAll(".tabs-toggle-order");
const tabsContent = document.querySelectorAll(".tabs-content-order");
...
function showTab(index) {
    ...
    toggleTabs.forEach((tab, tabIndex) => {
        if (tabIndex === index) {
            tab.classList.add("tab-active-order");
        } else {
            tab.classList.remove("tab-active-order");
        }
    });
