<div id="LoginRegisterBox"
    class="fixed inset-0 z-50 !text-white flex items-center justify-center invisible opacity-0 bg-secondary-accent-color/70 add-to-cart-quick-list font-aesthetnova">
    <div id="LoginBox"
        ...
        <form action="{{ route('login') }}" method="POST"
            ...
            <div class="relative">
                <input required autocomplete="" type="password" name="password"
        ...
        <svg xmlns="http://www.w3.org/2000/svg"
            class="absolute cursor-pointer closeloginBox lg:top-6 top-3 lg:right-6 right-3" width="20" height="20"
    ...
    <div id="RegisterBox"
        ...
        <form action="{{ route('register') }}" method="POST"
            ...
            <div class="relative">
                <input required type="text" name="phone" value="{{ old('phone') }}" class="w-full h-12 border-b-[1px]
                            border-white bg-transparent outline-none" placeholder="Phone Number" />
