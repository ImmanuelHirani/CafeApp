...
<body>
    ...
    <main>
        <section class="container grid grid-cols-12 gap-6 mt-20 auto-rows-[100%] profile font-aesthetnova">
            ...
            {{-- Profile --}}
            <div class="col-span-8 overflow-hidden sideMenu-tabs-content rounded-2xl bg-secondary-accent-color">
                <div class="banner">
            ...
            <div class="col-span-8 overflow-hidden sideMenu-tabs-content rounded-2xl bg-secondary-accent-color">
                ...
                <div class="flex flex-col w-full gap-6 p-6 3xl:p-12 body">
                    <div class="flex items-center justify-between gap-4 wrap-button">
                        <button
                            class="w-full py-2 text-base transition-all duration-300 ease-in-out rounded-lg outline outline-2 outline-white hover:bg-secondary-color hover:outline-none tabs-toggle-order ">Paid</button>
                        <button
                            class="w-full py-2 text-base transition-all duration-300 ease-in-out rounded-lg outline outline-2 outline-white hover:bg-secondary-color hover:outline-none tabs-toggle-order ">Completed</button>
                        <button
                            class="w-full py-2 text-base transition-all duration-300 ease-in-out rounded-lg outline outline-2 outline-white hover:bg-secondary-color hover:outline-none tabs-toggle-order ">Canceled</button>
                        <button
                            class="w-full py-2 text-base transition-all duration-300 ease-in-out rounded-lg outline outline-2 outline-white hover:bg-secondary-color hover:outline-none tabs-toggle-order ">Serve</button>
                        <button
                            class="w-full py-2 text-base transition-all duration-300 ease-in-out rounded-lg outline outline-2 outline-white hover:bg-secondary-color hover:outline-none tabs-toggle-order ">Shipping</button>
                    </div>
                    <div class="text-white tabs-content-order">
                        <div class="swiper">
                            <div class="p-2 profile-order-wrapper">
                                <div class="w-full swiper-wrapper">
                                    @foreach ($transactions as $transaction)
                                        @if ($transaction->status_order == 'paid')
                                            <div
                                                class="h-fit swiper-slide flex bg-primary-color flex-col items-center outline w-[30rem] outline-highlight-content outline-1 gap-3 rounded-lg p-3">
                                                <div class="relative flex items-center w-full gap-8 wrap">
                                                    <img src="https://cdn-icons-png.flaticon.com/512/4852/4852525.png"
                                                        class="w-[8rem] h-[8rem] object-cover bg-secondary-accent-color rounded-md"
                                                        alt="">
                                                    ...
                                                    <div class="flex justify-end w-full px-3 wrap">
                                                        <!-- Order Status -->
                                                        <label for=""
                                                            class="px-3 py-2 text-sm text-white bg-green-500 rounded-full">
