    ...
    <section class="mt-10 md:mt-20 cart">
        <div class="container">
            <div class="flex flex-col grid-cols-12 gap-4 md:grid">
                                ...
                                <div
                                    ...
                                    <div class="flex md:w-[30%] w-[70%]  flex-col gap-3 wrap">
                                        ...
                                        <div class="flex items-center gap-3 md:hidden wrap">
                                            <form action="{{ route('cart.update', $cart->transaction_ID) }}" method="POST"
                                                class="cart-form">
                                                @csrf
                                                @method('PUT')
                                                <div
                                            ...
                                            <form action="{{ route('delete.cart', $cart->transaction_ID) }}" method="POST"
                                                class="delete-form">
                                                @csrf
                                                @method('delete')
                                                <button type="button"
                                    ...
                                    <div class="md:flex hidden items-center justify-center w-[20%]  wrap">
                                        <p class="text-xl md:text-lg" id="subtotal-{{ $cart->transaction_detail_ID }}">
                                            Rp {{ number_format($cart->subtotal, 0, ',', '.') }}
                                        </p>
                                    </div>
                                </div>
                ...
                <div class="sticky col-span-4 transition-all duration-300 ease-in-out top-36 box-cart font-aesthetnova">
                    ...
                    <div class="flex flex-col gap-3 px-3 py-3 rounded-b-lg content-body bg-secondary-accent-color">
                        ...
                        @if (isset($cart))
                            <span class="flex items-center justify-between py-4">
                                ...
                                <p class="text-lg md:text-xl" id="totalsubtotal-{{ $cart->transaction_detail_ID }}">
