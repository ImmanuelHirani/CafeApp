...
@endsection
@section('content')
    <section id="hero" class="relative flex items-center w-full h-screen overflow-hidden">
        <div class="container flex flex-col-reverse items-center w-full gap-6 mt-10 lg:mt-24 lg:gap-0 lg:flex-row">
            <!-- Left Content -->
            <div
                ...
                <div id="ExploreBtn"
                    class="relative inline-flex items-center justify-center gap-2 overflow-hidden rounded-md shadow-2xl text-white outline hover:bg-secondary-color hover:outline-none transition-all ease-in-out duration-300 outline-white w-fit">
                    <a href=""
        ...
        <video src="{{ asset('/asset/Pizza HD_2.mp4') }}" class="absolute inset-0 object-cover w-full h-full -z-10" loop
    ...
    <section id="toppings" class="flex items-center overflow-x-hidden lg:h-screen">
        <div
            ...
            <div class="flex lg:flex-row flex-col items-center md:gap-6 gap-3 mx-auto right-content lg:w-[40%] w-full">
                <div
                    ...
                    <div
                        class="absolute bottom-0 flex items-center justify-center w-full p-3 transition-all duration-300 ease-in-out bg-secondary-accent-color/70 topping-name">
                        <h6 class="text-center">Peperoni</h6>
                    </div>
                </div>
                <div class="lg:flex grid grid-cols-2 flex-wrap items-center lg:gap-6 gap-3 md:min-w-[1000px] w-full">
                    <div
                        ...
                        <img src="{{ asset('/asset/Topping/Topping2.png') }}" class="object-cover w-full h-full" alt="" />
                        <div
                            class="absolute flex items-center justify-center w-12 h-12 overflow-hidden transition-all duration-300 ease-in-out rounded-full bg-secondary-accent-color/70 md:w-16 md:h-16 top-3 left-3 box-number">
                            <h5 class="items-start md:mt-3 mt-1.5">
                                02
                            </h5>
                        </div>
                        <div
                            class="absolute bottom-0 flex items-center justify-center w-full p-2 transition-all duration-300 ease-in-out bg-secondary-accent-color/70 h-fit topping-name">
                            <h6 class="text-center">Mushroom</h6>
                        </div>
                    </div>
                    <div
                        class="relative 2xl:min-w-[300px] lg:rounded-none rounded-t-lg 2xl:h-[250px] md:min-w-[150px] md:h-[215px] min-w-[150px] h-[139px] img-wrap group overflow-hidden">
                        <img src="{{ asset('/asset/Topping/Topping3.png') }}" class="object-cover w-full h-full" alt="" />
                        <div
                            class="absolute flex items-center justify-center w-12 h-12 overflow-hidden transition-all duration-300 ease-in-out rounded-full bg-secondary-accent-color/70 md:w-16 md:h-16 top-3 left-3 box-number">
                            <h5 class="items-start md:mt-3 mt-1.5">
                                03
                    ...
                    <div
                        class="relative 2xl:min-w-[300px] lg:rounded-none rounded-t-lg 2xl:h-[250px] md:min-w-[150px] md:h-[215px] min-w-[150px] h-[139px] img-wrap group overflow-hidden">
                        <img src="{{ asset('/asset/Topping/Topping4.png') }}" class="object-cover w-full h-full" alt="" />
                        <div
                            class="absolute flex items-center justify-center w-12 h-12 overflow-hidden transition-all duration-300 ease-in-out rounded-full bg-secondary-accent-color/70 md:w-16 md:h-16 top-3 left-3 box-number">
                            <h5 class="items-start md:mt-3 mt-1.5">
                                04
                    ...
                    <div
                        class="relative 2xl:min-w-[300px] lg:rounded-none rounded-t-lg 2xl:h-[250px] md:min-w-[150px] md:h-[215px] min-w-[150px] h-[139px] img-wrap group overflow-hidden">
                        <img src="{{ asset('/asset/Topping/Topping5.png') }}" class="object-cover w-full h-full" alt="" />
                        <div
                            class="absolute flex items-center justify-center w-12 h-12 overflow-hidden transition-all duration-300 ease-in-out rounded-full bg-secondary-accent-color/70 md:w-16 md:h-16 top-3 left-3 box-number">
                            <h5 class="items-start md:mt-3 mt-1.5">
                                05
                    ...
                    <div
                        class="relative 2xl:min-w-[300px] lg:rounded-none rounded-t-lg 2xl:h-[250px] md:min-w-[150px] md:h-[215px] min-w-[150px] h-[139px] img-wrap group overflow-hidden">
                        <img src="{{ asset('/asset/Topping/Topping6.png') }}" class="object-cover w-full h-full" alt="" />
                        <div
                            class="absolute flex items-center justify-center w-12 h-12 overflow-hidden transition-all duration-300 ease-in-out rounded-full bg-secondary-accent-color/70 md:w-16 md:h-16 top-3 left-3 box-number">
                            <h5 class="items-start md:mt-3 mt-1.5">
                                06
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div
                                ...
                                <div
                                    class="absolute w-12 h-12 p-3 transition-all duration-500 ease-in-out -translate-y-full bg-opacity-50 rounded-full opacity-0 md:w-16 md:h-16 top-2 topping-logo right-2 overlay-icon bg-primary-color/40 outline-2 outline-white">
                                    <img src="{{ asset('asset/Topping/choco - logo.png') }}" class="w-[100%]" alt="" />
                                </div>
                                <figcaption
                                    class="absolute bottom-0 translate-x-1/2 translate-y-full md:p-4 p-2.5 opacity-0 transition-all ease-in-out duration-500 rounded-b-2xl right-1/2 w-full text-center overlay-content-title">
                                    <h6>Slime Choco</h6>
                                </figcaption>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div
                                ...
                                <div
                                    class="absolute w-12 h-12 p-3 transition-all duration-500 ease-in-out -translate-y-full bg-opacity-50 rounded-full opacity-0 md:w-16 md:h-16 top-2 topping-logo right-2 overlay-icon bg-primary-color/40 outline-2 outline-white">
                                    <img src="{{ asset('asset/Topping/jam - logo.png') }}" class="w-[100%]" alt="" />
                                </div>
                                <figcaption
                                    class="absolute bottom-0 translate-x-1/2 translate-y-full md:p-4 p-2.5 opacity-0 transition-all ease-in-out duration-500 rounded-b-2xl right-1/2 w-full text-center overlay-content-title">
                        ...
                        <div class="swiper-slide">
                            <div
                                ...
                                <div
                                    class="absolute w-12 h-12 p-3 transition-all duration-500 ease-in-out -translate-y-full bg-opacity-50 rounded-full opacity-0 md:w-16 md:h-16 top-2 topping-logo right-2 overlay-icon bg-primary-color/40 outline-2 outline-white">
                                    <img src="{{ asset('asset/Topping/chees - logo.png') }}" class="w-[100%]" alt="" />
                                </div>
                                <figcaption
                                    class="absolute bottom-0 translate-x-1/2 translate-y-full md:p-4 p-2.5 opacity-0 transition-all ease-in-out duration-500 rounded-b-2xl right-1/2 w-full text-center overlay-content-title">
                                    <h6>Mozarella</h6>
            ...
            <div class="container relative flex items-center justify-between w-full mt-4 md:mt-0">
                <div class="flex gap-4 swiper-custom-nav">
                    <svg id="prev" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 42 42"
                        ...
                        <path d="M28 21H14M14 21L18 17M14 21L18 25" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                    <svg id="next" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <path d="M14 21L28 21M28 21L24 25M28 21L24 17" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                </div>
                <div id="btn-custom"
                    class="relative inline-flex items-center justify-center overflow-hidden transition-all duration-500 ease-in-out rounded-full outline hover:outline-none hover:bg-secondary-color  md:outline-white md:bg-transparent bg-secondary-color md:w-[4em] h-[2.5em] md:hover:w-[14em] will-change-transform md:h-[4em]">
    ...
    <section id="more-menu" class="overflow-x-hidden bg-secondary-accent-color">
        <div class="container">
            <div class="flex flex-col items-center gap-6 text-center xl:gap-12 headline-content">
                ...
                <hr class="w-1/2 border-white/30" />
            ...
            <div class="flex flex-col gap-10 mt-6 lg:gap-20 lg:mt-20 main-content">
                <div class="flex flex-col items-center grid-cols-2 gap-6 lg:grid md:gap-12 coffee">
                    ...
                    <div class="flex flex-col gap-6 md:gap-8 desc-content">
                        ...
                        <div id="coffe-menu"
                            class="relative moreMenu inline-flex items-center justify-center ms-auto overflow-hidden transition-all duration-500 ease-in-out rounded-full outline hover:outline-none hover:bg-secondary-color  md:outline-white md:bg-transparent bg-secondary-color w-fit md:w-[4em] h-[2.5em] md:hover:w-[21em] will-change-transform md:h-[4em]">
                            <a href="/menu#coffee"
                ...
                <div class="flex flex-col-reverse items-center justify-between grid-cols-2 gap-6 md:gap-12 lg:grid bubble">
                    <div class="flex flex-col gap-6 md:gap-8 desc-content">
                        ...
                        <div id="bubble-menu"
                            class="relative inline-flex moreMenu items-center justify-center overflow-hidden transition-all duration-500 ease-in-out rounded-full outline hover:outline-none hover:bg-secondary-color  md:outline-white md:bg-transparent bg-secondary-color md:w-[4em] w-fit h-[2.5em] md:hover:w-[22em] will-change-transform md:h-[4em]">
                            <a href="/menu#bubble"
