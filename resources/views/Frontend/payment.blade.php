        ...
        <div class="container">
            <div class="flex flex-col grid-cols-12 gap-4 md:grid">
                <div class="col-span-6 transition-all duration-300 ease-in-out box-cart font-aesthetnova">
                    <div class="flex flex-col p-2.5 rounded-lg md:p-8 gap-y-8 content-body bg-secondary-accent-color">
                        <!-- Repeted Content -->
                        ...
                        <!-- Cancel Order Form -->
                        <form id="cancel-form" action="{{ route('order.cancel', $orderTransaction->transaction_ID) }}"
                            method="POST">
                            @csrf
                            @method('PUT')
                ...
                <div class="col-span-6 row-auto gap-4 text-base md:text-lg">
                    <div
                        ...
                        <div class="flex flex-col items-center justify-between w-full px-4 py-4 md:gap-3 md:px-8 footer">
