...
<html lang="en">
  ...
  <body>
    <header class="fixed inset-x-0 top-0 z-50 md:top-12">
      <nav
        class="container relative w-full py-5 transition-all duration-300 ease-linear md:bg-transparent md:py-0"
      >
        <div
          id="main-nav"
          class="relative flex items-center justify-between w-full md:pl-4 md:pr-5 group"
        >
          <div class="left-nav">
            <a class="flex items-center gap-1">
              <img
                src="../asset/SVG/Pizza_logo-navbar.svg"
                class="md:w-[30%] w-[23%]"
                alt=""
              />
          ...
          <div class="box"></div>
          <div
            class="hidden translate-x-1/2 lg:absolute right-1/2 middle-nav font-magilo lg:block"
          >
            <div
              class="flex items-center justify-center gap-16 2xl:gap-20 link-wrapper"
            >
              ...
              <a
                class="text-xl opacity-80 3xl:text-2xl"
                href="custom-pizza.html"
              >
                Custom Pizza
              </a>
          ...
          <div class="right-nav">
            <div class="flex items-center gap-3.5 md:gap-3 icon-wrap">
              <button id="cartTrigger">
                <img
                  src="../asset/SVG/Cart_add-navbar.svg"
                  class="w-10 md:w-14"
                  alt=""
                />
              </button>
              <button id="loginRegisterTrigger">
                <img
                  src="../asset/SVG/User_login_navbar.svg"
                  class="w-8 md:w-10"
                  alt=""
                />
              </button>
              <button
                id="navTrigger"
                class="flex items-center p-2 rounded-full xl:hidden bg-secondary-color"
              >
                <svg
    ...
    <main>
      <section class="mt-16 md:mt-20 contact-us">
        <div
          class="container flex flex-col items-center justify-center gap-8 md:gap-24"
        >
          <div
            class="flex flex-col items-center justify-center md:w-[40%] w-[80%] gap-3 text-center title-wrap"
          >
            <h2>Contact Us</h2>
            <h6>
          ...
          <div
            class="flex flex-col items-center grid-cols-7 gap-8 md:gap-24 md:grid content-wrapper"
          >
            <img
              src="../asset/Contact-us.png"
            ...
            <form action="" class="flex flex-col w-full col-span-3 gap-4">
              ...
              <input
                required
                type="text"
                class="w-full h-12 px-4 rounded-lg outline-none"
              ...
              />
              <label for=""><h6>Message</h6></label>
              <textarea
                required
                name=""
                class="p-4 rounded-l outline-none"
                id=""
                rows="3"
                placeholder="Tell Us What Is In Your Tought"
              ></textarea>
              <button
                type="submit"
                class="w-full py-3 rounded-lg bg-secondary-color"
              >
                Submit
              </button>
            </form>
      ...
      >
        <div class="flex w-full h-full max-w-3xl">
              ...
              >
                <div class="swiper-wrapper">
                  ...
                  <div class="swiper-slide">
                    ...
                    >
                      <img
                        src="../asset/Booba Menu/Choco bobba.jpg"
                        alt="Sicilian Pizza"
                        class="rounded-t-lg h-[180px] w-full object-cover"
                      />
                      <div
                        class="flex items-center justify-between w-full p-4 wrap"
                      >
                        ...
                        <button
                          class="w-10 h-10 text-red-500 bg-white rounded-full"
                        >
                          <img
                            src="../asset/SVG/Cart_Plus-Sidebar.svg"
                            alt=""
                            class="w-5 mx-auto"
                          />
                        </button>
                  ...
                  <div class="swiper-slide">
                    ...
                    >
                      <img
                        src="../asset/Booba Menu/Brown Sugar Syrup and Milk Tea bobba.jpg"
                        alt="Sicilian Pizza"
                        class="rounded-t-lg h-[180px] w-full object-cover"
                      />
                      <div
                  ...
                  <div class="swiper-slide">
                    ...
                    >
                      <img
                        src="../asset/Booba Menu/Oreo Bobba.jpg"
                        alt="Sicilian Pizza"
                        class="rounded-t-lg h-[180px] w-full object-cover"
                      />
                      <div
                  ...
                  <div class="swiper-slide">
                    ...
                    >
                      <img
                        src="../asset/Booba Menu/Milk bobba.jpg"
                        alt="Sicilian Pizza"
                        class="rounded-t-lg h-[180px] w-full object-cover"
                      />
                      <div
          ...
          <!-- My Cart Section -->
          <div
            class="relative md:w-[62%] w-full flex flex-col gap-3 p-6 bg-secondary-accent-color shadow-lg"
          >
              ...
              >
                ...
                <div class="h-fit swiper-wrapper">
                  <div class="swiper-slide">
                    ...
                    >
                      <img
                        src="../asset/Coffe menu/capuccino Coffe.jpg"
                        alt="Sicilian Pizza"
                        class="object-cover w-full rounded h-44 md:w-44 md:h-44"
                      />
                      <div
                        class="flex flex-col w-full gap-2 md:gap-3 text-wrap"
                      >
                        <p
                          class="text-xl font-semibold md:text-lg line-clamp-1"
                        >
                          Capuccino Coffee
                        </p>
                        ...
                        <div class="flex items-center justify-between wrap">
                          ...
                          >
                            ...
                            <span class="text-xl md:text-lg text-accent-color"
                              >2</span
                            >
                            <button class="">
                              <svg
            ...
            <div class="mt-auto">
              ...
              <a href="cart.html">
                <button
                  class="w-full py-3 mt-4 font-semibold bg-red-500 hover:bg-red-600"
                >
                  VIEW CART
                </button>
              </a>
      ...
      >
        ...
        >
          <h5
            class="absolute mt-3 text-gray-300 translate-x-1/2 lg:top-8 top-5 right-1/2"
          >
            Login
          </h5>
          <form
          ...
          >
            <div class="relative">
              ...
              />
              <svg
                class="absolute right-0 w-6 h-6 bottom-2"
                fill="white"
                viewBox="0 0 48 48"
                xmlns="http://www.w3.org/2000/svg"
              >
            ...
            <button
              type="submit"
              class="w-full py-3 mt-3 rounded-lg bg-secondary-color"
            >
              Login
            </button>
            <p class="text-center">
              Don't Have Account ?
              <span id="RegisterBoxOpen" class="text-red-500 cursor-pointer"
                >Sign Up</span
              >
            </p>
          </form>
          <img
            src="../asset/Bobba-login.png"
            class="absolute w-[10%] bottom-0 right-0"
            alt=""
          />
          <img
            src="../asset/Coffe-Login.png"
            class="absolute w-[8%] top-0 left-0"
            alt=""
          />
          <img
            src="../asset/Pizza-Hero.png"
          ...
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="absolute cursor-pointer closeloginBox lg:top-6 top-3 lg:right-6 right-3"
            width="20"
            height="20"
            viewBox="0 0 12 12"
            fill="none"
        ...
        >
          <h5
            class="absolute mt-3 text-gray-300 translate-x-1/2 lg:top-8 top-3 right-1/2"
          >
            Register
          </h5>
          <form
          ...
          >
            ...
            <p class="text-center">
              ...
              <span id="LoginBoxOpen" class="text-red-500 cursor-pointer"
                >Sign In</span
              >
            </p>
          </form>
    ...
    <footer class="flex flex-col bg-secondary-accent-color font-aesthetnova">
      <div class="container flex flex-col gap-12 py-12 md:py-20">
        <div
          class="flex flex-wrap w-full grid-cols-3 gap-20 md:grid wrapper-address"
        >
          <div
            class="flex flex-col items-center justify-center gap-4 mx-auto Wrap"
          >
            <h5>ADDRESS</h5>
        ...
        <div class="flex flex-col items-center gap-6 sosial-media">
          <div class="flex items-center justify-center gap-6 box-sosial wrap">
            <div
              class="flex items-center justify-center w-12 h-12 border-2 border-white rounded-full"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
        ...
        <div class="img-showcase-food">
          <div class="grid grid-cols-6 swiper-wrapper">
            <div class="img-wrap swiper-slide">
              <img
                src="../asset/Logo/Pizza Menu/Meat Lovers.jpg"
                class="w-full h-[243px] object-cover"
                alt=""
              />
            </div>
            <div class="img-wrap swiper-slide">
              <img
                src="../asset/Logo/Pizza Menu/Blackpaper.jpg"
                class="w-full h-[243px] object-cover"
                alt=""
              />
            </div>
            <div class="img-wrap swiper-slide">
              <img
                src="../asset/Coffe menu/Caramel Hazelnut Iced Coffee.jpg"
                class="w-full h-[243px] object-cover"
                alt=""
              />
            </div>
            ...
            <div class="img-wrap swiper-slide">
              <img
                src="../asset/Coffe menu/Dalgona Coffee.jpg"
                class="w-full h-[243px] object-cover"
                alt=""
              />
            </div>
            ...
            <div class="img-wrap swiper-slide">
              <img
                src="../asset/Logo/Pizza Menu/Chicken.jpg"
                class="w-full h-[243px] object-cover"
                alt=""
              />
            </div>
            ...
            <div class="img-wrap swiper-slide">
              <img
                src="../asset/Logo/Pizza Menu/Peperoni.jpg"
                class="w-full h-[243px] object-cover"
                alt=""
              />
            </div>
            <div class="img-wrap swiper-slide">
              <img
                src="../asset/Coffe menu/Caramel Machiato.jpg"
                class="w-full h-[243px] object-cover"
                alt=""
              />
            </div>
            <div class="img-wrap swiper-slide">
              <img
                src="../asset/Booba Menu/Matcha.jpg"
                class="w-full h-[243px] object-cover"
                alt=""
              />
            </div>
